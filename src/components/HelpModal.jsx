        ...
        >
          ...
          <div className="flex-grow overflow-auto mb-6 pr-2">
            <p className="mb-3 text-lg">
              ...
              , where each player tries to guess the identity of the other
              person's chosen character. Here, all the characters on the board
              are your mutual followers!
            </p>
            <ol className="text-lg list-decimal ml-6 space-y-3">
              ...
              <li>
                Take turns asking yes/no questions to deduce who the other
                person chose. When answering questions, you can say
                yes/no/unsure. To help deduce, you can click on a follower's
                card to disable it and take it off the possible choices.
                <img
              ...
              <li>
                Click Reset All to reset the board if you want to play a new
                game.
              </li>
            </ol>
          </div>
